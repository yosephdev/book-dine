...
urlpatterns = [
    ...
    path('restaurant/<str:place_id>/write-review/', booking_views.write_review_view, name='write_review'),
    path('restaurant/<str:place_id>/', booking_views.restaurant_detail_view, name='restaurant_detail'),
    path('make-reservation/<str:place_id>/', booking_views.make_reservation, name='make_reservation'),
